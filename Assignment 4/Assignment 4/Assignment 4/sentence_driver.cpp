/***********************************PROGRAM HEADER************************************************
Name: Steven Fernandez                        TOTAL POINTS:  25                DUE DATE:  02/22/2021
COURSE:  COP3530
Assignment Name:  Assignment#4                Professor:  Dr. Bullard

Description: This program manages a linked-list of strings. It enables a creation of linked-lists, remove items or add items to the list,
			 copying of lists, finding a length of the list and checking if two lists are equal to each other.
*********************************************************************************************/
